...
bool    ImGui_ImplOpenGL3_CreateDeviceObjects()
{
    ...
    const GLchar *fragment_shader_glsl_120 =
        ...
        "void main()\n"
        "{\n" /* SRGB correction */
        "    vec4 frag = Frag_Color * texture2D(Texture, Frag_UV.st);\n"
        "    gl_FragColor = vec4(pow(frag.xyz, vec3(2.2)), frag.w);\n"
        "}\n";
    ...
    const GLchar *fragment_shader_glsl_130 =
        ...
        "void main()\n"
        "{\n" /* SRGB correction */
        "    vec4 frag = Frag_Color * texture(Texture, Frag_UV.st);\n"
        "    Out_Color = vec4(pow(frag.xyz, vec3(2.2)), frag.w);\n"
        "}\n";
